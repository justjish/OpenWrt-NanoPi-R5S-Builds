...
git clone -b openwrt-main --single-branch https://github.com/openwrt/openwrt.git $OPENWRT_FOLDER
git clone -b immortalwrt-main --single-branch https://github.com/immortalwrt/immortalwrt.git $IMMORTALWRT_FOLDER
